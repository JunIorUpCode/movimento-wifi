/**
 * Página de login do painel do cliente.
 * 
 * Funcionalidades:
...
import { Lock, Mail, AlertCircle, Wifi } from 'lucide-react'
import { ApiError } from '../services/api'

/**
 * LoginPage Component
 * 
 * Página de autenticação para clientes (tenants).
      ...
      if (err instanceof ApiError) {
        ...
        switch (err.code) {
          ...
          case 'ACCOUNT_SUSPENDED':
            ...
            break
          case 'TRIAL_EXPIRED':
            setError('Período de teste expirado. Por favor, atualize seu plano.')
            break
          default:
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Monitoramento de Presença e Movimento
            </p>
          </div>
